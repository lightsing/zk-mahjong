...
contract PlonkVerifier {
    // Omega
    uint256 constant w1 = 13536764371732269273912573961853310557438878140379554347802702086337840854307;    
    // Scalar field size
    ...
    uint32 constant n         = 2097152;
    uint16 constant nPublic   = 6;
    uint16 constant nLagrange = 6;
    
    uint256 constant Qmx  = 19021175268713318981171993416836605162449546466606014185221503317734444377658;
    uint256 constant Qmy  = 321291729952968661693922227785481070322283133869908984427712556173498865804;
    uint256 constant Qlx  = 15529805405037040450474814967434746042659423795215758842379042623712422773305;
    uint256 constant Qly  = 2475173833942858593004603963160500287312395905348250280989729555669524424552;
    uint256 constant Qrx  = 15931763923790198610177264944185804231365019051862569633041817434750733956199;
    uint256 constant Qry  = 1296132859504783802942360086253705096944289204655212355045059808995431286399;
    uint256 constant Qox  = 20074594160481561052578954404345085174109947516006376554080253084534126479468;
    uint256 constant Qoy  = 1289180432551841882649958915062607258334524271714201648910904906742646287581;
    uint256 constant Qcx  = 17845150369927581971867326138870449705780736293338386080346964669700342036968;
    uint256 constant Qcy  = 11900222781244884553472480530339427576651085269720563648013674198539648457192;
    uint256 constant S1x  = 8951903490602547531931830224968437176231016394780146288125494279053982246351;
    uint256 constant S1y  = 1536378636104462878707387969325250921336519052910405756963406533698040218390;
    uint256 constant S2x  = 11237566604482559608399145802881037774486690500282037274057139110393761840135;
    uint256 constant S2y  = 17771282120344759279226186395452015548116097747030157365845436527538062626227;
    uint256 constant S3x  = 7613123911065766952257117096830956908326639933979612203200884638996305757628;
    uint256 constant S3y  = 1881276953590128103267631501620009031922645212139352898861760543696190374949;
