import { zkMahjongKeyGen, zkMahjongKeyToPubkey, zkMahjongPubkeyAggregate, zkMahjongUnmaskMessage, lookupTile } from 'zk-mahjong-wasm-sys';
...
export class AggregatedMahjongPubkey {
    ...
    constructor(pubkeys: MahjongPubkey[]) {
        this.key = zkMahjongPubkeyAggregate(pubkeys.map(pubkey => pubkey.key) as Point[])
    }
}
